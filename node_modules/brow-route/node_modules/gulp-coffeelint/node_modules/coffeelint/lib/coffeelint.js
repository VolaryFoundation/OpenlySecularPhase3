...
module.exports = Indentation = (function() {
  ...
  Indentation.prototype.getCorrectIndent = function(tokenApi) {
    var curIndent, i, lineNumber, lines, prevIndent, prevLine, prevNum, tokens, twoAbove, _ref, _ref1, _ref2;
    ...
    if ((twoAbove != null ? twoAbove.match(/^\s*(#|$)/) : void 0) != null) {
      twoAbove = "";
    }
    if (prevIndent > 0 || ((twoAbove != null ? twoAbove.match(/\.$/) : void 0) != null)) {
